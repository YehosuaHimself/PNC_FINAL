...
(function pageTransitions() {
  ...
  curtain.style.cssText = 'position:fixed;inset:0;background:#1A0F08;z-index:99998;pointer-events:none;transform:translateY(-100%);transition:transform 0.52s cubic-bezier(0.76,0,0.24,1);will-change:transform';
